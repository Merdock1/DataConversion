...
{
    NR_STATE_16BIT_REGISTER, // Name for the 16-bit state register
    NR_TOTAL_REGISTERS,
};
...
void setup()
{
    ...
    Serial.print("Register 0 BIN= ");
    Serial.println(state16bitRegister, BIN);
    delay(1500);
...
void loop()
{
    ...
    if (currentMillis - previousMillis >= 1000)
    {
        ...
        Serial.print("bitValue00: ");
        Serial.println(bitValue00);
        Serial.print("bitValue01: ");
        Serial.println(bitValue01);
        Serial.print("bitValue02: ");
        Serial.println(bitValue02);
        Serial.print("bitValue03: ");
        Serial.println(bitValue03);
        Serial.print("bitValue04: ");
        Serial.println(bitValue04);
        Serial.print("bitValue05: ");
        Serial.println(bitValue05);
        Serial.print("bitValue06: ");
        Serial.println(bitValue06);
        Serial.print("bitValue07: ");
        Serial.println(bitValue07);
        Serial.print("bitValue08: ");
        Serial.println(bitValue08);
        Serial.print("bitValue09: ");
        Serial.println(bitValue09);
        Serial.print("bitValue10: ");
        Serial.println(bitValue10);
        Serial.print("bitValue11: ");
        Serial.println(bitValue11);
        Serial.print("bitValue12: ");
        Serial.println(bitValue12);
        Serial.print("bitValue13: ");
        Serial.println(bitValue13);
        Serial.print("bitValue14: ");
        Serial.println(bitValue14);
        Serial.print("bitValue15: ");
        Serial.println(bitValue15);

        // Print the decimal value of the state16bitRegister
        Serial.print("Register 0 = ");
        Serial.println(state16bitRegister);
